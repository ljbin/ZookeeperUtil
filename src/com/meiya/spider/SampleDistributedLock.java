...
public class SampleDistributedLock implements Watcher {
    ...
    private static final String CONNECTION_STRING = "172.16.2.212:2181";
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SampleDistributedLock.class);

    public SampleDistributedLock(int id) {
        this.threadId = id;
    ...
    public static void main(String[] args) {
        for (int i = 0; i < THREAD_NUM; i++) {
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        SampleDistributedLock dc = new SampleDistributedLock(threadId);
    ...
    /**
     * 获取锁成功    要做的事情都放在这里做了  通过zookeeper的watch回调这个方法
     */
